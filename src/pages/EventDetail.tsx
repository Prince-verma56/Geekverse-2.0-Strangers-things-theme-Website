        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-zinc-900/90 backdrop-blur-xl border border-crimson/30 rounded-3xl p-6 shadow-2xl sticky top-24">
                    ...
                    <Button className="w-full bg-crimson hover:bg-crimson/90 text-white text-lg py-6 rounded-xl shadow-[0_0_15px_rgba(220,38,38,0.5)] hover:shadow-[0_0_25px_rgba(220,38,38,0.7)] transition-all">
                        Apply Now
                    </Button>
